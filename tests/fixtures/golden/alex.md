diskvet 0.2.2 · ClickHouse 25.12.1.649 · detected: Langfuse
...
```sh
sudo sh -c 'touch /var/lib/clickhouse/flags/force_drop_table && chmod 666 /var/lib/clickhouse/flags/force_drop_table'
```
```sql
